...
if plot_histogram:
    ...
    hist1 = ax3.hist(y_integral)
    ax3.set(title='Distribution', xlabel='Thrust', ylabel='Integral')

    plt.tight_layout()
    plt.show()

    integral_mean = np.mean(y_integral)
    integral_std = np.std(y_integral)

    print()
    print('Integral Mean:', integral_mean)
    print('Integral Std:', integral_std)
    print('"Actual" Integral:', y_integral[0])
