...
for iteration in range(it_start, it_len + 1):
    ...
    if plot_3D:
        ...
        scat11 = ax11.scatter(BIG_3d_data_mod[:, 0], BIG_3d_data_mod[:, 1], BIG_3d_data_mod[:, 2], s=5, c='k')
        #scat11 = ax11.scatter(BIG_3d_data[:, 0], BIG_3d_data[:, 1], BIG_3d_data[:, 2], s=5, c='k')  # Actual Data
