...
ex_range = [20.7, 21.2]
ex_range_y = np.linspace(-22, 22)
ex_range_x1 = [ex_range[0]]*len(ex_range_y)
ex_range_x2 = [ex_range[1]]*len(ex_range_y)
...
ax1.plot(ex_range_x1, ex_range_y, '--k', linewidth=2)
ax1.plot(ex_range_x2, ex_range_y, '--k', linewidth=2)
#ax1.set(
    #title='Stats 5 - Groupings of Recorded Sweep Angles',
    #xlabel='Sweep Angle', ylabel='Sweep Angle')
